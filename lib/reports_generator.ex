defmodule ReportsGenerator do
  ...
  def fetch_higher_cost(_eport, _option), do: {:error, "Invalid option!"}
  ...
  # defp handle_response({:ok, file_content}), do: file_content
  # defp handle_response({:error, _reason}), do: "Error while opening file!"
end
